...
class Boggle():
    ...
    def find_from(self, board, word, y, x, seen, size):
        ...
        if y > 0:
            if self.find_from(board, word[1:], y - 1, x, seen, size):
                return True
        ...
        if x > 0:
            if self.find_from(board, word[1:], y, x - 1, seen, size):
                return True
        ...
        # diagonals
        if y > 0 and x > 0:
            if self.find_from(board, word[1:], y - 1, x - 1, seen, size):
                return True
    ...
    def find(self, board, word, size):
        ...
        for y in range(0, size):
            for x in range(0, size):
                if self.find_from(board, word, y, x, seen=set(), size=size):
                    return True
